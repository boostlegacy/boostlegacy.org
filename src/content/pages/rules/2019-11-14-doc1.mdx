...
* You are required to attend all matches you qualify for unless permitted by an administrator. Infraction of this rule can result in loss of any prize earned.
...
* Boost Legacy Standard Tournaments are Single Elimination, Best of 3 (BO3) until the Semi-Finals, which are Best of 5 (BO5) and then Grand-Final which is best of 7 (BO7).
